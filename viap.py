...
def tactic2(f,o,a,pre_condition,conclusions,vfact,inputmap,constaints,const_var_map):
	for conclusion in conclusions:
		...
		for x in const_map:
			...
			if '==' in str(conclusion) and '<' not in  str(conclusion) and '>' not in str(conclusion) and '!' not in str(conclusion) and 'ite' not in str(conclusion) and 'And(' not in str(conclusion) and 'Or(' not in str(conclusion) and 'Not(' not in str(conclusion) and 'Implies(' not in str(conclusion):
			...
			elif '!=' in str(conclusion) and '<' not in  str(conclusion) and '>' not in str(conclusion) and 'ite' not in str(conclusion) and 'And(' not in str(conclusion) and 'Or(' not in str(conclusion) and 'Not(' not in str(conclusion) and 'Implies(' not in str(conclusion):
				exp=str(conclusion).split('!=')
				invariantstmtdisplay_left=None
				invariantstmtdisplay_right=None
				if '/' in str(exp[0]):
				...
				basecasestmt=str(exp[0])+"!="+str(exp[1])
			elif 'And(' in str(conclusion) or 'Or(' in str(conclusion) or 'Not(' not in str(conclusion) or 'Implies(' not in str(conclusion):
				sub_list={}
