...
_s.add(X1 == X)
_s.add(i1 == _N1)
_s.add(sum1 == (6*power(_N1,11)+33*power(_N1,10)+55*power(_N1,9)-66*power(_N1,7)+66*power(_N1,5)-33*power(_N1,3)+5*_N1)/66)
_s.add(_N1 >= X)
_s.add(Or(_N1==0,(_N1-1) < X))
_s.add(_N1>=0)
_s.add(X>=0)
_s.add(Not((6*power(_N1,11)+33*power(_N1,10)+55*power(_N1,9)-66*power(_N1,7)+66*power(_N1,5)-33*power(_N1,3)+5*_N1)/66==(6*power(X,11)+33*power(X,10)+55*power(X,9)-66*power(X,7)+66*power(X,5)-33*power(X,3)+5*X)/66))
if sat==_s.check():
