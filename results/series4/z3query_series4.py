...
_s.add(X1 == X)
_s.add(i1 == _N1)
_s.add(sum1 == (6*power(_N1,5)+15*power(_N1,4)+10*power(_N1,3)-_N1)/30)
_s.add(_N1 >= X)
_s.add(Or(_N1==0,(_N1-1) < X))
_s.add(_N1>=0)
_s.add(X>=0)
_s.add(Not((6*power(_N1,5)+15*power(_N1,4)+10*power(_N1,3)-_N1)/30==(6*power(X,5)+15*power(X,4)+10*power(X,3)-X)/30))
if sat==_s.check():
