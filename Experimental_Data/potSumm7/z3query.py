...
_s.add(X1 == X)
_s.add(i1 == _N1)
_s.add(sum1 == (3*power(_N1,8)+12*power(_N1,7)+14*power(_N1,6)-7*power(_N1,4)+2*power(_N1,2))/24)
_s.add(_N1 >= X)
_s.add(ForAll([_n1],Implies(And((_n1<_N1),_n1>=0),_n1 < X)))
_s.add(Or(_N1==0,_N1 - 1 < X))
_s.add(_N1>=0)
_s.add(X>=0)
_s.add(Not((3*power(_N1,8)+12*power(_N1,7)+14*power(_N1,6)-7*power(_N1,4)+2*power(_N1,2))/24==(3*power(X,8)+12*power(X,7)+14*power(X,6)-7*power(X,4)+2*power(X,2))/24))
if sat==_s.check():
