...
_s.add(X1 == X)
_s.add(i1 == _N1)
_s.add(sum1 == (2*power(_N1,10)+10*power(_N1,9)+15*power(_N1,8)-14*power(_N1,6)+10*power(_N1,4)-3*power(_N1,2))/20)
_s.add(_N1 >= X)
_s.add(ForAll([_n1],Implies(And((_n1<_N1),_n1>=0),_n1 < X)))
_s.add(Or(_N1==0,_N1 - 1 < X))
_s.add(_N1>=0)
_s.add(X>=0)
_s.add(Not((2*power(_N1,10)+10*power(_N1,9)+15*power(_N1,8)-14*power(_N1,6)+10*power(_N1,4)-3*power(_N1,2))/20==(2*power(X,10)+10*power(X,9)+15*power(X,8)-14*power(X,6)+10*power(X,4)-3*power(X,2))/20))
if sat==_s.check():
