...
_s.add(Y>0)
_s.add(_k1>=0)
_s.add(Not(Implies(And(X==Y*q7(_k1) + r7(_k1),power(2,(_N1-_k1-1))*Y<=r7((_k1))),X==Y*(If(power(2,(_N1-_k1-1))*Y<=r7((_k1)),power(2,(_N1-_k1-1))+q7((_k1)),q7(_k1))) + (If(power(2,(_N1-_k1-1))*Y<=r7((_k1)),(-power(2,(_N1-_k1-1)))*Y+r7((_k1)),r7(_k1))))))
if sat==_s.check():
