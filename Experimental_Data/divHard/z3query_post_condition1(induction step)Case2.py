...
_s.add(ForAll([_n1],Implies(And((_n1<_N1),_n1>=0),X>=power(2,_n1)*Y)))
_s.add(Or(_N1==0,X >= Y*power(2, _N1 - 1)))
...
_s.add(ForAll([_n2],Implies(And((_n2<_N2),_n2>=0),(power(2,(_N1-_n2))!=1))))
...
_s.add(Y>0)
_s.add(_k1>=0)
_s.add(Not(Implies(And(X==Y*q7(_k1) + r7(_k1),Not(power(2,(_N1-_k1-1))*Y<=r7((_k1)))),X==Y*(If(power(2,(_N1-_k1-1))*Y<=r7((_k1)),power(2,(_N1-_k1-1))+q7((_k1)),q7(_k1))) + (If(power(2,(_N1-_k1-1))*Y<=r7((_k1)),(-power(2,(_N1-_k1-1)))*Y+r7((_k1)),r7(_k1))))))
if sat==_s.check():
